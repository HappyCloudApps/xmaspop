		...
		**/
		public function changeState(stateTo:String):void
		{
			...
			if (!(stateTo in _states)){
				trace("[StateMachine]",_state,"Cannot make transition: State "+ stateTo +" is not defined");
				return;
			}
			...
			{
				trace("[StateMachine]",_state,"Transition to "+ stateTo +" denied");
			...
			trace("[StateMachine]",oldState,"State Changed to " + _state);
